      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            Center(
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24.0), // MODIFIED: Removed vertical padding here
                child: SingleChildScrollView(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      const Spacer(), // MODIFIED: Pushes content down from the top
                      _buildHeader(),
                      const SizedBox(height: 16),
                      _buildMissionStatement(),
                      const SizedBox(height: 24),
                      _buildActionButtons(context),
                      const Spacer(), // MODIFIED: Pushes the tech showcase and footer apart
                      _buildTechShowcase(context),
                      const SizedBox(height: 80), // MODIFIED: Ensure enough space for the footer
                    ],
